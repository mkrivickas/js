...
*/
console.log('--------------');
console.log('skaičiaus konvertavimas į stringą');
console.log((5215).toString());
console.log('' + 5215);

console.log('--------------');
console.log('dešimtainės dalies "nukirpimas');
...
console.log('--------------');
console.log('teksto konvertavimas į skaičių');
...
console.log('random skaičius: [0..1)');
console.log(Math.random());
console.log(Math.random());
console.log(Math.random());
console.log(Math.random());
console.log('min-max');
console.log(Math.min(1, 5, 7, -4, 3)); // priima vien TIK skaičius
console.log(Math.min([1, 5, 7, -4, 3])); // NaN
console.log(Math.max(1, 5, 7, -4, 3)); // priima vien TIK skaičius
...
console.log('"sukarpyti" stringą į dalis');
...
console.log(
    labas.slice(labas.indexOf('r'), labas.indexOf('s', labas.indexOf('r')) + 1)
);
...
console.log('teksto "apvalymas" nuo tarpų');
...
console.log('map - individualių reikšmių konvertavimas');
...
console.log('sort'); // rūšiuoja kaip tekstą pradedant a, b, c, etc..
const nums = [1, 2, 3, 10, 20, 30, 11, 21, 31];
console.log(marks.sort());
console.log(nums.sort());
console.log(nums.sort((a, b) => a - b)); // nuo mažiausio iki didžiausio
console.log(nums.sort((a, b) => b - a)); // nuo didžiausio iki mažiausio
...
console.log('automatinis visų objekto raktažodžių ištraukimas');
const personKeys = Object.keys(person);
console.log(personKeys);

console.log('automatinis visų objekto reikšmių ištraukimas');
console.log('FOR-OF'); // dirba su masyvu (raktažodžiais), kuriuos pasigamina iš objekto
for (const key of personKeys) {
    console.log(key, ':', person[key]);
}

console.log('FOR-IN'); // dirba tiesiogiai su objektu
